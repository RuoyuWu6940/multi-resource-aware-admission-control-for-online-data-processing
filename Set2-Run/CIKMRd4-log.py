...
def traceStatisticSetUp():
    ...
    caseInLength = \
        [10, 10, 10, 11, 11, 11, 11, 12, 12, 12, 12, 12, 12, 12, 13, 13, 13, 13, 14, 14, 14, 15, 15, 15, 15, 16, 16, 16,
...
if __name__ == '__main__':
    ...
    for traceLength in range(traceLengthRange[0],traceLengthRange[1]+1):
        ...
        for case in range(caseStartingNumber, caseNumberPerLength[traceLength-traceLengthRange[0]]+caseStartingNumber):
            ...
            DATA_DIR = "cikm_data_lognorm.csv"
    ...
    print("\nAverageAllTraces with Lognorm Every Alg:", [[TraceAverageOurs, TraceAverageGreedy, TraceAverageSingleK, TraceAverageAdaptive, TraceAverageRandomEta]])
    print("RuntimeAllTraces with Lognorm Every Alg:", [[RuntimePerPromptOurs, RuntimePerPromptGreedy, RuntimePerPromptSingleK, RuntimePerPromptAdaptive, RuntimePerPromptRandomEta]])
